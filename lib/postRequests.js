...
module.exports.addProduct = function(req, res){
	try {
		...
		form.parse(req, function(err, fields, files) {
			...
			var product = new Product({name: fields.name, nameUpperCase: fields.name.toUpperCase(), category: fields.category, 
			subcategory: fields.subcategory, address: fields.address, price: fields.price, quantity: Number(fields.quantity),
