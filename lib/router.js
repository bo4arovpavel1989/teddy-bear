...
var deleteRequestsHendlers=require('./deleterequests.js');
...
var deleteRequests = [
	{
		...
		middleware: checkAccess,
		callback: deleteRequestsHendlers.deleteCategory
	},
	{
		url: '/admin/deletesubcategory',
		middleware: checkAccess,
		callback: deleteRequestsHendlers.deleteSubCategory
	},
	{
		url: '/admin/deleteproduct',
		middleware: checkAccess,
		callback: deleteRequestsHendlers.deleteProduct
	},
	{
		url: '/admin/deletespecialprop',
		middleware: checkAccess,
		callback: deleteRequestsHendlers.deleteSpecialProp
	},
	{
		url: '/admin/deletecallback',
		middleware: checkAccess,
		callback: deleteRequestsHendlers.deleteCallback
	},
	{
		url: '/admin/deleteorder',
		middleware: checkAccess,
		callback: deleteRequestsHendlers.deleteOrder
	},
	{
		url: '/admin/deleteorderpermanently',
		middleware: checkAccess,
		callback: deleteRequestsHendlers.deleteOrderPermanently
	}
];
