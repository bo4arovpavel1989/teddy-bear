...
var getFedexPage=require('./getrequests.js').getFedexPage;
var getContactsPage=require('./getrequests.js').getContactsPage;
var getArticlesPage=require('./getrequests.js').getArticlesPage;
var getAboutPage=require('./getrequests.js').getAboutPage;
var getHowOrderPage=require('./getrequests.js').getHowOrderPage;
...
var getRequests = [
	...
	},
	{
		url: '/fedex',
		middleware: noMiddleware,
		callback: getFedexPage
	},
	{
		url: '/contacts',
		middleware: noMiddleware,
		callback: getContactsPage
	},
	{
		url: '/about',
		middleware: noMiddleware,
	...
	},
	{
		url: '/articles',
		middleware: noMiddleware,
		callback: getArticlesPage
	},
	{
		url: '/howorder',
		middleware: noMiddleware,
		callback: getHowOrderPage
	},
	{
		url: '/cart',
		middleware: noMiddleware,
